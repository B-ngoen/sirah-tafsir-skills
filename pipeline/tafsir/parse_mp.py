# -*- coding: utf-8 -*-
"""Parse cached HTML -> pages_full.jsonl (multiprocessing version for PC).
...
BOOKS = {
    "43":    ("tabari", "تفسير الطبري جامع البيان - ط دار التربية والتراث"),
    "23608": ("maraghi", "تفسير المراغي"),
    "8967":  ("shabuni", "صفوة التفاسير"),
    "1509":  ("ibnkathir_awlad", "تفسير ابن كثير - ط أولاد الشيخ"),
    "1503":  ("ibnkathir_jawzi", "تفسير ابن كثير - ط ابن الجوزي"),
}
