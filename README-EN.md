...
| **ChatGPT** desktop app, **Work** mode (has terminal access) | Paste the same sentence as for Claude Code: *"Please study https://github.com/B-ngoen/sirah-tafsir-skills and install it as a skill."* Without Work mode: create a Project / Custom GPT (upload 2 files + instructions). | ★★★ | [docs/chatgpt.md](docs/chatgpt.md) |
