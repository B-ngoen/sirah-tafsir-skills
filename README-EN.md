...
| **sirah-lookup** | 🔜 soon | Ibn Hishām (2 eds.) · Ibn Isḥāq · Ṭabaqāt Ibn Saʿd · Tārīkh al-Ṭabarī · al-Iṣābah · Usd al-Ghābah (2 eds.) · al-Istīʿāb — 175 events/years & ~9,700 Companions |
...
**claude.ai / Claude apps:** download `tafsir-lookup.skill` from [Releases](https://github.com/B-ngoen/sirah-tafsir-skills/releases/tag/tafsir-v1) → Settings → Capabilities → Skills → Upload. The database downloads automatically inside Claude's sandbox on first use.
