...
| **Claude Desktop — Cowork / Code mode** (has terminal access) | In Cowork, paste: *"Please study https://github.com/B-ngoen/sirah-tafsir-skills and install it as a skill."* The skill lands in `~/.claude/skills/` and is also available in regular Claude Desktop/mobile chats. | ★★★ | [docs/claude.md](docs/claude.md) |
...
| **ChatGPT** — **Work mode only**, desktop app (regular chat and mobile cannot run it) | In Work, paste the same sentence as for Claude Code: *"Please study https://github.com/B-ngoen/sirah-tafsir-skills and install it as a skill."* Also available as a ready Codex plugin (`codex-plugin/`). | ★★★ | [docs/chatgpt.md](docs/chatgpt.md) |
