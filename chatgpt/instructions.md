...
7. Baris CAKUPAN wajib tepat sebelum Catatan: kelima kitab dengan status `dikutip` / `ada, belum dikutip (N paragraf)` / `tidak ada` — agar kitab yang tersedia tidak terlewat diam-diam (kejadian nyata: Maraghi & Ibnu Katsir tidak dikutip tanpa keterangan).
