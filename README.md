...
| **ChatGPT** — web/aplikasi desktop (Plus/Team); **siapkan lewat PC**, Project-nya lalu muncul juga di aplikasi HP | Di PC: klik **Work/Projects** → Project baru → unggah 2 berkas (program pencari + basis data) → tempel petunjuk. | ★★★ | [docs/chatgpt.md](docs/chatgpt.md) |
