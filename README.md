...
| **ChatGPT** — aplikasi desktop, mode **Work** (punya akses terminal) | Tempel kalimat yang sama seperti Claude Code: *"Tolong pelajari https://github.com/B-ngoen/sirah-tafsir-skills dan install sebagai skill."* Tanpa mode Work: buat Project/Custom GPT (unggah 2 berkas + petunjuk). | ★★★ | [docs/chatgpt.md](docs/chatgpt.md) |
